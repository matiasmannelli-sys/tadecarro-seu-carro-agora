  ...
  return (
    <section className="relative bg-[#090A2E] overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-4 pt-10 pb-8">
        ...
        {/* Headline */}
        <h1 className="text-[28px] leading-[1.15] font-extrabold text-[#F6F5F3] mb-3 max-w-md">
          Seu limite já está{" "}
        ...
        <p className="text-sm text-[#F6F5F3]/60 mb-6 max-w-sm leading-relaxed">
        ...
        <Link
          ...
          className="inline-flex items-center gap-2 bg-[#E5541C] hover:bg-[#E5541C]/90 text-white font-bold text-sm px-6 py-3.5 rounded-xl transition-all active:scale-95 shadow-lg shadow-[#E5541C]/25"
        >
          Ver produtos
