  ...
  return (
    <div className="w-full px-4 py-3">
      <div className="flex justify-between items-center mb-2">
        ...
        <span className="text-sm font-semibold text-brand-light">{percentage}%</span>
      </div>
      ...
      <p className="text-xs text-muted-foreground mt-1.5 text-center">
        Faltam <span className="text-brand font-medium">{monthsLeft} meses</span> para o carro ser seu!
      </p>
    </div>
  );
};
